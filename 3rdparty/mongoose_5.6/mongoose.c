...
static int mg_match_prefix(const char *pattern, ssize_t pattern_len, const char *str) {
  const char *or_str;
  int len, res, i = 0, j = 0;
...
#ifndef MONGOOSE_NO_FILESYSTEM
static void mg_send_file_internal(struct mg_connection *c, const char *file_name,
